import type { MediaCard7Styles } from"../_styles";
export type MediaCard7Data = {
  imgSrc: string;
  href: string;
  title: string;
  text: string;
...
export default function MediaCard7({ d, styles }: { d: MediaCard7Data; styles: MediaCard7Styles }) {
  return (
    <li className={cn("flex relative flex-col cursor-pointer", styles.className)}>
      <img className={cn("w-46 h-46 block max-w-60 overflow-clip", styles.className2)} data-component="image" alt="" src={d.imgSrc} />
      {""}
