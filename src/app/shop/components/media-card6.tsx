import type { MediaCard6Styles } from"../_styles";
export type MediaCard6Data = {
  imgSrc: string;
  href: string;
  title: string;
  text: string;
...
export default function MediaCard6({ d, styles }: { d: MediaCard6Data; styles: MediaCard6Styles }) {
  return (
